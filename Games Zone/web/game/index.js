...
(function (root, factory) {
    ...
    SeeBattle.prototype = {
        ...
        startNewGame: function(){
            this.userName = this.userName || prompt('თქვენი სახელი?', '');
            this.pcName = this.pcName || prompt('მოწინააღმდეგის სახელი', '');

            if(!this.userName || !this.pcName){
                alert('სახელი არასწორია');
                return;
            }

            this.startGameButton.innerHTML = 'თავიდან დაწყება...';
            this.pcInfo.innerHTML = this.pcName + ' (თქვენი მოწინააღმდეგე)';
            this.userInfo.innerHTML = this.userName + ' (თქვენი უჯრა)';
        ...
        updateToolbar: function(){
            this.toolbar.innerHTML = 'ქულა - ' + this._pcHits + ':' + this._userHits;
            if(this.isGameStopped()){
                if(this._userHits >= this._hitsForWin){
                    this.toolbar.innerHTML += ', თქვენ მოიგეთ';
                }else{
                    this.toolbar.innerHTML += ', მოიგო თქვენმი მოწინააღმდეგე';
                }
            }else if(this.isPCGoing()){
                this.toolbar.innerHTML += ', თქვენი მოწინააღმდეგის ჯერია';
            }else{
                this.toolbar.innerHTML += ', თქვენი ჯერია';
            }
        },
    };
